...
export const messages = {
  vi: {
    ...
    settings: {
      ...
      balance: 'Số dư', inventory: 'Tồn kho', affordable: 'Có thể thuê', price: 'Đơn giá', proxyHint: 'Mỗi dòng một proxy; hệ thống luôn chọn ngẫu nhiên.',
      useProxy: 'Dùng proxy', proxyPool: 'Danh sách proxy', proxyCount: '{selected} / {total} được chọn', proxyAllUsed: 'Không chọn dòng nào: dùng ngẫu nhiên toàn bộ.',
      proxyEmpty: 'Chưa có proxy.', saveProxies: 'Lưu proxy', selectedRandom: 'Chỉ random trong các dòng đã chọn.', directMode: 'Proxy đang tắt; luồng sẽ kết nối trực tiếp.',
  ...
  en: {
    ...
    settings: {
      ...
      affordable: 'Affordable', price: 'Unit price', proxyHint: 'One proxy per line; routing is always random.', useProxy: 'Use proxy', proxyPool: 'Proxy list',
      proxyCount: '{selected} / {total} selected', proxyAllUsed: 'No rows selected: randomly use the full list.', proxyEmpty: 'No proxies yet.', saveProxies: 'Save proxies',
      selectedRandom: 'Only randomize across selected rows.', directMode: 'Proxy is off; flows connect directly.', line: 'Line {line}', saved: 'Saved', saveFailed: 'Save failed',
    },
    status: {
  ...
  'zh-CN': {
    ...
    settings: {
      ...
      balance: '余额', inventory: '库存', affordable: '可租用', price: '单价', proxyHint: '每行一个代理；系统始终随机选择。', useProxy: '使用代理', proxyPool: '代理列表',
      proxyCount: '已选择 {selected} / {total}', proxyAllUsed: '未选择任何行：随机使用全部代理。', proxyEmpty: '暂无代理。', saveProxies: '保存代理',
      selectedRandom: '仅在已选择的代理中随机。', directMode: '代理已关闭；任务将直接连接。', line: '第 {line} 行', saved: '已保存', saveFailed: '保存失败',
    },
    status: {
